                      ...
                      <form class="form-horizontal style-form" action="insert-nilai.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
			                      ...
			                      //   ORDER BY nama_siswa");
                                  $sql = mysql_query("SELECT siswa.nama_siswa,siswa.kode_siswa,kelas_siswa.kode_siswa FROM siswa,kelas_siswa WHERE kelas_siswa.kode_kelas=$kk and kelas_siswa.kode_siswa=siswa.kode_siswa");
                                    if(mysql_num_rows($sql) != 0){
                                    while($data = mysql_fetch_assoc($sql)){
...
$.ajax({
url: "ambilsiswa.php",
kelas_siswa: "kode_kelas="+kode_kelas,
cache: false,
