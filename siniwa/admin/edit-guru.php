      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Guru &raquo; Edit Guru</h3>
            ...
            ?>
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Edit Guru</h4>
                      <form class="form-horizontal style-form" action="update-guru.php" method="post" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="kode_guru" type="text" id="kode_guru" class="form-control" value="<?php echo $data['kode_guru'];?>"  readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NIP</label>
                              <div class="col-sm-10">
                                  <input name="nip" type="text" id="nip" class="form-control" value="<?php echo $data['nip'];?>"autofocus="on" required />
