      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Laporan &raquo; Data Pelajaran</h3><br /><br />
          	<div class="row mt">
              <div class="col-lg-4">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan-pelajaran.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div>
              <br />
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-book"></i> Data Pelajaran </h3> 
                        </div>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th>Nama Pelajaran <i class="fa fa-sort"></i></th>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="pelajaran_pdf.php" class="btn btn-sm btn-info">Cetak  <i class="fa fa-print"></i></a>
                </div>
              </div> 
              </div>
            </div><!-- col-lg-12-->      	
